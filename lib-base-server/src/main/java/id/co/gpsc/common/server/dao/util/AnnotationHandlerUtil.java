package id.co.gpsc.common.server.dao.util;

import id.co.gpsc.common.server.dao.util.impl.ColumnAnnotationHandler;
import id.co.gpsc.common.server.dao.util.impl.JoinColumnAnnotationHandler;
