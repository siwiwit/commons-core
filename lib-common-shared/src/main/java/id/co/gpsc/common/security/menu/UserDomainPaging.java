package id.co.gpsc.common.security.menu;
...
public class UserDomainPaging implements Serializable,IsSerializable, IJSONFriendlyObject<UserDomainPaging>{
	...
	public void translateToJSON(ParsedJSONContainer jsonContainer) {
		...
		jsonContainer.put("totalData",getTotalData());
		  List<id.co.gpsc.common.security.menu.UserDomain> param4 = getUserDomains() ; 
		 if (  param4 != null && !param4.isEmpty()){ 
			for ( id.co.gpsc.common.security.menu.UserDomain scn : param4){
