...
public class PasswordPolicy extends BaseAuditedObject implements IJSONFriendlyObject<PasswordPolicy> {
	...
	**/
	@Id
	@TableGenerator(name = "generator_password_policy",
					table = "hibernate_sequences",
					pkColumnName = "sequence_name",
					valueColumnName = "sequence_next_hi_value",
					pkColumnValue = "sec_password_policy", 		      	  		      	    
					allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.TABLE, generator="generator_password_policy")
