...
import id.co.gpsc.common.client.form.FlowDrivenRadioButtonGroup;

/**
 * Komponent yg menampilkan Label, titik dua dan radio group area. Komponen ini harus di-wrapper dalam tag table<br>
 * <code> 		
 * 		< table ><br>
 * 			< tr ><br>
 * 				< td >< /td ><br>
 * 				< td >< /td><br>
 * 				< td >< p1:FlowDrivenRadioGroupWithLabel ui:field="txtBoxTest2" /> < /td><br>
 * 			< tr ><br> 			
 * 		</ table>
 * </code>
 ...
 * @since 17 aug 2012
 */
public class FlowDrivenRadioGroupWithLabel extends FlowDrivenRadioButtonGroup implements AutomaticLabeledControl{
	 ...
	 * Default Constructor
	 */
	public FlowDrivenRadioGroupWithLabel(){
		super();
	}
