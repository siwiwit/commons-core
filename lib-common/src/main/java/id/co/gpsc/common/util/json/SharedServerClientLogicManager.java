package id.co.gpsc.common.util.json;
 ...
 * <ol>
 * <li>di code client, parser musti di set pada saat onModulLoad. anda bisa mempergunakan : {@link id.co.gpsc.common.client.util.ClientSideWrappedJSONParser}</li>
