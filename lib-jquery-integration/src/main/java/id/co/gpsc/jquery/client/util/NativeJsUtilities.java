...
public final class NativeJsUtilities {
	...
	private native void putSharedWorker ()/*-{
		$wnd[@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_PUT_OBJECT_METHOD_NAME]=function (target, key , value){
		...
		$wnd[@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_GET_OBJECT_METHOD_NAME]=function (target, key ){
			if ( target==null|| key==null|| key.length==0)
				return ;
			if ( key.indexOf(".")>-1){
				var arr = key.split(".");
	...
	public native boolean getBoolean(JavaScriptObject target , String key)/*-{
		return !!$wnd[@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_GET_OBJECT_METHOD_NAME](target, key);
	}-*/; 
	...
	public native String  getString(JavaScriptObject target , String key)/*-{
		...
		var methodName =@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_GET_OBJECT_METHOD_NAME;  
		try{
	...
	public native Float  getFloat(JavaScriptObject target , String key)/*-{
		var swap =$wnd[@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_GET_OBJECT_METHOD_NAME](target, key);
		if ( swap==null)
			return null ; 
		if ( $wnd.isNaN( swap  /1) )
		 	return null ; 
	...
	public native void putStringButNumber (JavaScriptObject target , String key , String value)/*-{
		$wnd[@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_PUT_OBJECT_METHOD_NAME](target, key, value/1);
	}-*/;
	...
	public native void putNullObject (JavaScriptObject target , String key )/*-{
		$wnd[@id.co.gpsc.jquery.client.util.NativeJsUtilities::SHARED_PUT_OBJECT_METHOD_NAME](target, key, null);
	}-*/;
